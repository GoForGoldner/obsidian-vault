...
START
Basic
Load Balancing: What's the core difference between L4 and L7 load balancing?
...
START
Basic
Load Balancing: A TCP/database service must preserve the original client IP. L4 or L7, and why?
...
START
Basic
Load Balancing: You need to route `/api` and `/static` to different backend pools. L4 or L7, and why?
...
START
Basic
Load Balancing: Which load-balancing layer can terminate TLS / offload SSL, and why not the other?
