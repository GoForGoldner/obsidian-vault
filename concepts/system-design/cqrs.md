...
START
Basic
CQRS: What does CQRS actually separate, and what does a "command" return vs a "query"?
...
START
Basic
CQRS: You're told a system "uses CQRS." Does that mean it must have two separate databases?
...
START
Basic
CQRS: When does Event Sourcing naturally fit onto the write side of a CQRS system?
...
START
Basic
CQRS: What's the main cost/risk CQRS introduces?
