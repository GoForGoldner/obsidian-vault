...
START
Basic
Conditional Rendering and Lists: You write `{count && <Banner/>}` and when count is 0 the page shows a stray "0". Why, and what's the fix?
...
START
Basic
Conditional Rendering and Lists: How do you render "either A or B" inside JSX, given you can't use an `if` statement there?
...
START
Basic
Conditional Rendering and Lists: You map an array to `<li>` elements. Why does React require a `key` on each, and what makes a good key?
...
START
Basic
Conditional Rendering and Lists: What's the concrete bug from using the array index as a `key` in a reorderable/editable list?
...
START
Basic
Conditional Rendering and Lists: How do you make a component render nothing at all?
...
START
Basic
Conditional Rendering and Lists: How do you turn an array of data into a list of React elements?
