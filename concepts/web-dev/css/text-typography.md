...
START
Basic
Text and Typography: Write the CSS to truncate a single line of text with an ellipsis (…) when it overflows its box.
...
START
Basic
Text and Typography: Why is a unitless `line-height` (e.g. `1.5`) preferred over `line-height: 24px` or `1.5em`?
...
START
Basic
Text and Typography: What is the purpose of a `font-family` like `'Inter', system-ui, sans-serif` having multiple values?
...
START
Basic
Text and Typography: Which property uppercases text visually without changing the underlying HTML, and how does it differ from typing capitals?
...
START
Basic
Text and Typography: You want to remove the underline from a link. Which property and value?
...
START
Basic
Text and Typography: Which property controls horizontal alignment of inline/text content — and what does it NOT center?
