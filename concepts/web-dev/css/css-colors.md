...
START
Basic
CSS Colors: What's the difference between setting `opacity: 0.5` on an element and using a color with 50% alpha like `rgb(0 0 0 / 0.5)`?
...
START
Basic
CSS Colors: What does the `currentColor` keyword resolve to, and why is it useful?
...
START
Basic
CSS Colors: In `hsl(255 90% 75%)`, what does each of the three values represent?
...
START
Basic
CSS Colors: What does the hex shorthand `#fff` expand to, and what does a 4th pair like `#ffffff80` add?
...
START
Basic
CSS Colors: Write a background color that is pure black at 50% transparency using modern CSS syntax.
