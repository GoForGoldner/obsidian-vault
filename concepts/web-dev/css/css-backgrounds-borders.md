...
START
Basic
CSS Backgrounds and Borders: What's the key difference between `border` and `outline` in terms of layout?
...
START
Basic
CSS Backgrounds and Borders: What does each value mean in `box-shadow: 0 4px 24px rgba(0,0,0,0.4)`?
...
START
Basic
CSS Backgrounds and Borders: Write the CSS to give an element a left-to-right gradient background from purple to light purple.
...
START
Basic
CSS Backgrounds and Borders: What are the three parts of the `border` shorthand, in order?
...
START
Basic
CSS Backgrounds and Borders: You want a focus indicator that's clearly visible but doesn't nudge surrounding elements when it appears. Which property, and what pushes it off the edge?
