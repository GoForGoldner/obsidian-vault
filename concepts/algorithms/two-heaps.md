...
START
Basic
Two Heaps: You see: need to find the median of a stream of numbers efficiently. What technique?
...
START
Basic
Two Heaps: What are the three invariants you must maintain in the Two Heaps pattern?
...
START
Basic
Two Heaps: Why is the left heap usually implemented as a max-heap?
