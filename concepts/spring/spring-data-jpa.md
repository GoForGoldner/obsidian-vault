...
START
Basic
Spring Data JPA: What's the difference between `@OneToMany` and `@ManyToOne`, and which side owns the relationship?
...
START
Basic
Spring Data JPA: What does `@Transactional` do and where should you put it?
...
START
Basic
Spring Data JPA: How does `@Version` enable optimistic locking?
...
START
Basic
Spring Data JPA: When do you use `@Query` vs derived query methods in Spring Data?
...
START
Basic
Spring Data JPA: `@Entity` + `@Table`: what annotations do you need to map a class to a table?
...
START
Basic
Spring Data JPA: `@GeneratedValue`: what are the 4 strategies?
...
START
Basic
Spring Data JPA: `@Enumerated`: how do you persist enums?
...
START
Basic
Spring Data JPA: `@Embedded` / `@Embeddable`: how do you use value objects?
...
START
Basic
Spring Data JPA: `@ManyToMany` with `@JoinTable`: how do you map it?
...
START
Basic
Spring Data JPA: `@Inheritance`: what are the 3 JPA strategies?
...
START
Basic
Spring Data JPA: Derived query methods: what naming conventions does Spring Data support?
...
START
Basic
Spring Data JPA: `@Lock`: how do you use pessimistic locking?
...
START
Basic
Spring Data JPA: When would you choose JPA `JOINED` inheritance over `SINGLE_TABLE`?
...
START
Basic
Spring Data JPA: Why is JPA `TABLE_PER_CLASS` inheritance usually avoided?
