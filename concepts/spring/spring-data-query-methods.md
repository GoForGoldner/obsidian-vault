...
START
Basic
Spring Data Query Methods: What does the introducing keyword (`findBy`/`countBy`/`existsBy`/`deleteBy`) of a derived method determine?
...
START
Basic
Spring Data Query Methods: How does Spring Data resolve which field `findByAddressCity` refers to, and how do you force the boundary?
...
START
Basic
Spring Data Query Methods: Does a derived `deleteByStatus(...)` method need `@Modifying`?
...
START
Basic
Spring Data Query Methods: What's the difference between `deleteByStatus` returning `long` vs returning `List<User>`?
...
START
Basic
Spring Data Query Methods: How do you limit a derived query to the first/top N rows?
...
START
Basic
Spring Data Query Methods: Write a Spring Data method: users older than 18 whose name starts with "A", ordered by registration date descending.
...
START
Basic
Spring Data Query Methods: How do you add paging or sorting to a derived query method?
...
START
Basic
Spring Data Query Methods: For a case-insensitive `LIKE '%term%'` derived method, which keywords do you combine?
...
START
Basic
Spring Data Query Methods: For date fields, why prefer `After`/`Before` over `GreaterThan`/`LessThan`?
...
START
Basic
Spring Data Query Methods: When should you abandon a derived method name in favor of `@Query`?
