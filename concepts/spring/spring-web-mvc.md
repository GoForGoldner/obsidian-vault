...
START
Basic
Spring Web MVC: What's the difference between `@Controller` and `@RestController`?
...
START
Basic
Spring Web MVC: How do `@PathVariable`, `@RequestParam`, and `@RequestBody` differ?
...
START
Basic
Spring Web MVC: How do you implement global exception handling in Spring?
...
START
Basic
Spring Web MVC: `@RequestParam`: how do you handle optional parameters with defaults?
...
START
Basic
Spring Web MVC: `@Valid` vs `@Validated`: what's the difference?
...
START
Basic
Spring Web MVC: `@ResponseStatus`: how do you set HTTP status on a method or exception?
...
START
Basic
Spring Web MVC: `@ModelAttribute`: what does it do?
...
START
Basic
Spring Web MVC: `@CrossOrigin`: how do you enable CORS?
...
START
Basic
Spring Web MVC: `@CookieValue` and `@RequestHeader`: how do you read them?
...
START
Basic
Spring Web MVC: What's the full `@RestControllerAdvice` pattern for API error handling?
