...
START
Basic
Exceptions: What's the rule for checked vs unchecked exceptions, and which classes are unchecked?
...
START
Basic
Exceptions: What does this return and why?<br>`try { return 1; } finally { return 2; }`
...
START
Basic
Exceptions: Does `finally` always run? Name the exceptions.
...
START
Basic
Exceptions: What two rules govern multi-catch `catch (A | B e)`?
...
START
Basic
Exceptions: Why won't this compile?<br>`catch (IOException e) {...} catch (FileNotFoundException e) {...}`
...
START
Basic
Exceptions: How do you preserve the original cause when wrapping an exception, and why bother?
...
START
Basic
Exceptions: What must a custom exception extend to be checked vs unchecked?
...
START
Basic
Exceptions: Where does try-with-resources fit, and what does it handle that plain finally doesn't?
