...
START
Basic
Java Set and Map: When do you choose `HashMap` vs `TreeMap` vs `LinkedHashMap`?
...
START
Basic
Java Set and Map: What are `NavigableSet`'s four nearest-element methods?
...
START
Basic
Java Set and Map: Can `HashMap` and `TreeMap` have null keys?
...
START
Basic
Java Set and Map: Why do `HashSet` and `HashMap` require `equals()` and `hashCode()` agreement?
...
START
Basic
Java Set and Map: What's the difference between `SortedSet.headSet(e)` and `NavigableSet.headSet(e, inclusive)`?
...
START
Basic
Java Set and Map: How do you use `HashMap.computeIfAbsent()` to build a graph adjacency list?
...
START
Basic
Java Set and Map: What does `HashSet` use internally?
...
START
Basic
Java Set and Map: What is the `SortedSet.subSet(from, to)` method?
...
START
Basic
Java Set and Map: How do you iterate a `Map`'s entries and what's the most efficient way?
...
START
Basic
Java Set and Map: In `map.computeIfAbsent(k, fn)`, what happens if `fn` returns `null`, and what must `fn` never do?
...
START
Basic
Java Set and Map: What does `SortedMap.firstKey()` return, and what if the map is empty?
...
START
Basic
Java Set and Map: When is `LinkedHashMap.removeEldestEntry` called, and do you call it yourself?
...
START
Basic
Java Set and Map: What makes a `LinkedHashMap` behave as an LRU cache instead of insertion-ordered?
...
START
Basic
Java Set and Map: What does the load factor (e.g. `0.75f`) control in a `HashMap`/`LinkedHashMap`?
...
START
Basic
Java Set and Map: Why can't a `LinkedHashMap` implement an LFU cache?
...
START
Basic
Java Set and Map: In `map.merge(key, value, remappingFn)`, when does the function run and what does returning null do?
...
START
Basic
Java Set and Map: What happens if you add an element outside the range of a `headSet`/`subSet`/`tailSet` view?
